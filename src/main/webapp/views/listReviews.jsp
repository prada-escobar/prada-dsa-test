    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation"
            ...
            <li class=" nav-item"><a href="#"><i class="menu-livicon" data-icon="star"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li class="<s:if test='%{mode != "add"}'>active</s:if>"><a href="<s:url action='listReviews'/>"><i
                            class="bx bx-right-arrow-alt"></i><span class="menu-item"
                                                                    data-i18n="Invoice List">Listado</span></a>
                    </li>
                    <li class="<s:if test='%{mode == "add"}'>active</s:if>"><a href="<s:url action='addReviewForm'/>"><i
                            class="bx bx-right-arrow-alt"></i><span class="menu-item"
                                                                    data-i18n="Invoice">Crear Nuevo</span></a>
                    </li>
                </ul>
        ...
        <div class="content-header row">
            <div class="content-header-left col-12 mb-2 mt-1">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h5 class="content-header-title float-left pr-1 mb-0">Listado de Reviews</h5>
        ...
        <div class="content-body">
            ...
            <section class="invoice-list-wrapper">
                ...
                <div class="invoice-create-btn mb-1">
                    <a href="<s:url action='addReviewForm'/>" class="btn btn-primary glow invoice-create" role="button"
                       aria-pressed="true">Nuevo Review</a>
                </div>
                                    ...
                                    <table class="table table-hover mb-0 invoice-data-table">
                                        ...
                                        <s:iterator value="reviews">
                                            <tr>
                                                ...
                                                <td><s:property value="reviewDescription"/></td>
                                                <td><s:property value="reviewDate"/></td>
                                                <td><s:property value="reviewRating"/>/5</td>
                                                <td>
                                                    <div class="invoice-action">
                                                        <a href="<s:url action='viewReview' namespace='/'><s:param name='reviewId'><s:property value='reviewId'/></s:param></s:url>"
                                                           class="invoice-action-view mr-1">
                                                            <i class="bx bx-show-alt"></i>
                                                        </a>
                                                        <!-- Enlace para editar el review -->
                                                        <a href="<s:url action='editReview' namespace='/'><s:param name='reviewId'><s:property value='reviewId'/></s:param></s:url>"
                                                           class="invoice-action-edit mr-1 cursor-pointer">
                                                            <i class="bx bx-edit"></i>
                                                        </a>
                                                        <!-- Enlace para borrar el review-->
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header bg-danger">
                <h5 class="modal-title white" id="myModalLabel120">Eliminar Review</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i class="bx bx-x"></i>
                </button>
            </div>
            <div class="modal-body">
                ¿Está seguro de que desea eliminar el review?
            </div>
            <div class="modal-footer">
                <s:form action="deleteReview" method="post">
                    <s:hidden id="deleteReviewId" name="reviewId"/>
...
<script type="application/javascript">
    $('#delete').on('show.bs.modal', function (event) {
        ...
        var modal = $(this);
        modal.find('#deleteReviewId').val(reviewId);
    });
</script>
<!-- END: Page JS-->
